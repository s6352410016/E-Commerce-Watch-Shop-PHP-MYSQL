...
<body>
    ...
    $stmt = $adminObj->getAdminById();
    $row = $stmt->fetch(PDO::FETCH_ASSOC);
    ?>
    <div class="container mt-5" style="width: 800px;">
        <h3 class="text-center">แก้ไขแอดมิน</h3>
        <form class="mt-3" method="POST">
            <div class="d-flex" style="gap: 1rem;">
                <div class="mb-3" style="width: 50%;">
                    <label class="form-label">ชื่อจริง:</label>
                    <input type="text" class="form-control" name="adminFirstname" required value="<?php echo $row['adminFirstname']; ?>">
                </div>
                <div class="mb-3" style="width: 50%;">
                    <label class="form-label">นามสกุล:</label>
                    <input type="text" class="form-control" name="adminLastname" required value="<?php echo $row['adminLastname']; ?>">
                </div>
            </div>
            <div class="mb-3">
