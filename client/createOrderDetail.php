...
<body>
    ...
    <div class="container mt-5" style="width: 800px;">
        <h3 class="text-center">เพิ่มรายการสั่งซื้อสินค้า</h3>
        <form class="mt-3" method="POST">
            <div class="mb-3">
                <label class="form-label">ไอดีผู้ใช้ที่สั่งซื้อ:</label>
                <input type="number" class="form-control" name="userId" required min="1" pattern="\d*">
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control" name="productQuantity" required min="1" pattern="\d*">
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="userPostCode" required>
            </div>
            <div class="mb-3">
                <label class="form-label">เบอร์โทรศัพท์:</label>
                <input type="text" class="form-control" name="userPhone" required>
            </div>
            <button name="createOrderDetail" type="submit" class="btn btn-primary">เพิ่มรายการสั่งซื้อสินค้า</button>
            &nbsp;&nbsp;&nbsp;
    ...
    if (isset($_POST['createOrderDetail'])) {
        ...
        if ($orderDetailObj->createOrder()) {
            echo "<script>
                    Swal.fire(
                        'เพิ่มรายการสั่งซื้อสินค้าสำเร็จแล้ว!',
