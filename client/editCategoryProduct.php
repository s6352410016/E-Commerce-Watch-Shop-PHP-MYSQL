...
<body>
    ...
    <?php
      ...
      $categoryObj->categoryId = $_GET['id']; 
      $stmt = $categoryObj->getCategoryById(); 
    ...
    <div class="container mt-5" style="width: 800px;">
        ...
        <form class="mt-3" method="POST">
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="categoryBrand" required value="<?php echo $row['categoryBrand']; ?>">
            </div>
    ...
    if (isset($_POST['categoryBrand'])) {
        ...
        if ($categoryObj->updateCategory()) {
            echo "<script>
                    Swal.fire(
                        'แก้ไขประเภทสินค้าสำเร็จแล้ว!',
