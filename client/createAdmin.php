...
<body>
    ...
    <div class="container mt-5" style="width: 800px;">
        <h3 class="text-center">เพิ่มแอดมิน</h3>
        <form class="mt-3" method="POST">
            ...
            <button name="createAdmin" type="submit" class="btn btn-primary">เพิ่มแอดมิน</button>
            &nbsp;&nbsp;&nbsp;
    ...
    if (isset($_POST['createAdmin'])) {
        ...
        if ($adminObj->registerAdmin()) {
            echo "<script>
                    Swal.fire(
                        'เพิ่มแอดมินสำเร็จแล้ว!',
